    ...
    class Account {
        ...
        private function validateFirstName($fn) {
            if (strlen($fn) > 25 || strlen($fn) < 1) {
                array_push($this->errorArray, "Your first name must be between 1 and 25 characters");
                return;
            }
        }
        ...
        private function validatePasswords($pw, $pw2) {
            ...
            if (strlen($pw) > 28 || strlen($pw) < 7) {
                array_push($this->errorArray, "Your password must be between 7 and 28 characters");
                return;
            }
        }
